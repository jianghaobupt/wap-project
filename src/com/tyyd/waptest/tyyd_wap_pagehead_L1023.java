...
public class tyyd_wap_pagehead_L1023 {
	/**
  ...
  @Rule
  public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_pagehead_L1023");
  ...
  @Test
  public void testTyydWapPageheadL1023() throws Exception {
    ...
    assertTrue(isElementPresent(By.linkText("仙侠")));
    driver.findElement(By.linkText("仙侠")).click();
    assertEquals("首页> 男生 > 武侠仙侠", driver.findElement(By.cssSelector("p")).getText());
  }
