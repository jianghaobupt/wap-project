...
public class tyyd_wap_pagehead_L1010 {
	/**
  ...
  @Rule
  public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_pagehead_L1010");
  ...
  @Test
  public void testTyydWapPageheadL1010() throws Exception {
    driver.get(baseUrl + "/");
