...
public class tyyd_wap_pagehead_L1013 {
	/**
  ...
  @Rule
  public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_pagehead_L1013");
  ...
  @Test
  public void testTyydWapPageheadL1013() throws Exception {
    ...
    assertEquals("首页> 品质 > 影视剧本", driver.findElement(By.cssSelector("p")).getText());
