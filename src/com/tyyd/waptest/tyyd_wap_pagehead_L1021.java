...
public class tyyd_wap_pagehead_L1021 {
	/**
  ...
  @Rule
  public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_pagehead_L1021");
  ...
  @Test
  public void testTyydWapPageheadL1021() throws Exception {
