...
public class tyyd_wap_pagetail_L2001 {
  ...
  @Rule
  public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_pagetail_L2001");
  ...
  @Test
  public void testTyydWapPagetailL2001() throws Exception {
    ...
    assertEquals("品质", driver.findElement(By.xpath("//div[17]/p[1]/a[2]")).getText());
