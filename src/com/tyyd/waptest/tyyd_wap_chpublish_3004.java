...
public class tyyd_wap_chpublish_3004 {
  ...
  @Rule
  public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_chpublish_3004");
  ...
  @Test
  public void testTyydWapChpublish3004_1() throws Exception {
  ...
  @Test
  public void testTyydWapChpublish3004_2() throws Exception {
    driver.get(baseUrl + "/index.action?f=2");
    driver.findElement(By.linkText("男生")).click();
    assertTrue(isElementPresent(By.linkText("[专区]")));
    driver.findElement(By.linkText("[专区]")).click();
  ...
  @Test
  public void testTyydWapChpublish3004_3() throws Exception {
    driver.get(baseUrl + "/index.action?f=2");
    driver.findElement(By.linkText("男生")).click();
    assertTrue(isElementPresent(By.linkText("[专区]")));
    driver.findElement(By.linkText("[专区]")).click();
  ...
  @Test
  public void testTyydWapChpublish3004_4() throws Exception {
    driver.get(baseUrl + "/index.action?f=2");
    driver.findElement(By.linkText("男生")).click();
    assertTrue(isElementPresent(By.linkText("[专区]")));
    driver.findElement(By.linkText("[专区]")).click();
  ...
  @Test
  public void testTyydWapChpublish3004_5() throws Exception {
    driver.get(baseUrl + "/index.action?f=2");
    driver.findElement(By.linkText("男生")).click();
    assertTrue(isElementPresent(By.linkText("[专区]")));
    driver.findElement(By.linkText("[专区]")).click();
