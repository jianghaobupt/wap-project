...
public class tyyd_wap_chpublish_2005 {
  ...
  @Rule
  public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_chpublish_2005");
  ...
  @Test
  public void testTyydWapChpublish2005_1() throws Exception {
  ...
  @Test
  public void testTyydWapChpublish2005_2() throws Exception {
    driver.get(baseUrl + "/index.action?f=1");
    driver.findElement(By.linkText("品质")).click();
    assertTrue(isElementPresent(By.linkText("活动")));
    driver.findElement(By.linkText("活动")).click();
    try {
    	...
    	verificationErrors.append(e.toString()+"link of [返回上一页] isn't present!\n");
    }
  }
