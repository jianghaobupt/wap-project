...
public class tyyd_wap_pagetail_L2011 {
  ...
  @Rule
  public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_pagetail_L2011");
  ...
  @Test
  public void testTyydWapPagetailL2011() throws Exception {
    driver.get(baseUrl + "/index.action?");
    driver.findElement(By.linkText("书城")).click();
    assertEquals("排行", driver.findElement(By.xpath("//div[17]/p[1]/a[4]")).getText());  
