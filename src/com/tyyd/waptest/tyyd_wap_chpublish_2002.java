...
public class tyyd_wap_chpublish_2002 {
  ...
  @Rule
  public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_chpublish_2002");
  ...
  @Test
  public void testTyydWapChpublish2002() throws Exception {
    ...
    assertEquals("品质> 限免", driver.findElement(By.xpath("//div[2]")).getText());
  }
