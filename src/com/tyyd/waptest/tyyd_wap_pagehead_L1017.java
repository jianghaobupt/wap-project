...
public class tyyd_wap_pagehead_L1017 {
  ...
  @Rule
  public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_pagehead_L1017");
  ...
  @Test
  public void testTyydWapPageheadL1017_1() throws Exception {
...
//    assertEquals("排行 | 分类 | 包月 | 免费 | 软件", driver.findElement(By.xpath("//p[2]")).getText());
    ...
    assertEquals("【男生】", driver.findElement(By.cssSelector("div.mod-title")).getText());
  }
  
  @Test
  public void testTyydWapPageheadL1017_2() throws Exception {
    driver.get(baseUrl + "/index.action?");
    driver.findElement(By.linkText("品质")).click();
    assertTrue(isElementPresent(By.linkText("分类")));
    driver.findElement(By.linkText("分类")).click();
  ...
  @Test
  public void testTyydWapPageheadL1017_3() throws Exception {
    driver.get(baseUrl + "/index.action?");
    driver.findElement(By.linkText("品质")).click();
    assertTrue(isElementPresent(By.linkText("分类")));
    driver.findElement(By.linkText("分类")).click();
    assertEquals("【女生】", driver.findElement(By.xpath("//div[7]")).getText());
    assertEquals("【品质】", driver.findElement(By.xpath("//div[9]")).getText());
    try {
      assertTrue(isElementPresent(By.linkText("现代言情")));
    } catch (Error e) {
