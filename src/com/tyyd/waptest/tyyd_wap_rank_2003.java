...
public class tyyd_wap_rank_2003 {
	...
	@Rule
	public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_rank_2003");
	...
	@Test
	public void TyydWapRank2003() throws Exception {
		driver.navigate().to(baseUrl+"/index.action?f=2");
		...
		assertEquals("男生", driver.findElement(By.xpath("//div[3]/div/span")).getText());
