...
public class tyyd_wap_pzlink_1001 {
...
//		baseUrl = TxtHandle.readData(dataFile, 0);
	...
	@Rule
	public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_pzlink_1001");
	...
	@Test
	public void TyydWapPzlink1001() throws Exception {
		driver.navigate().to(baseUrl+"/index.action?f=0");
	    driver.findElement(By.linkText("品质")).click();
	    assertTrue(isElementPresent(By.linkText("经营")));
	    driver.findElement(By.linkText("经管")).click();
	    assertEquals("首页> 品质 > 财富经管", driver.findElement(By.cssSelector("p")).getText());
