...
public class tyyd_wap_boylink_1001 {
	...
	@Rule
	public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_boylink_1001");
	...
	@Test
	public void TyydWapBoylink1001() throws Exception {
	    ...
	    assertEquals("首页> 男生 > 官场沉浮", driver.findElement(By.cssSelector("p")).getText());
