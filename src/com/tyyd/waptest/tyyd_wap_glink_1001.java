...
public class tyyd_wap_glink_1001 {
...
//		baseUrl = TxtHandle.readData(dataFile, 0);
	...
	@Rule
	public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_glink_1001");
	...
	@Test
	public void TyydWapGlink1001() throws Exception {
