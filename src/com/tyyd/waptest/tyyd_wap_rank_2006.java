...
public class tyyd_wap_rank_2006 {
	...
	@Rule
	public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_rank_2006");
	...
	@Test
	public void TyydWapRank2006() throws Exception {
		...
		assertEquals("点击", driver.findElement(By.xpath("//div[3]/div/span")).getText());
