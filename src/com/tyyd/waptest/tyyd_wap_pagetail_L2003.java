...
public class tyyd_wap_pagetail_L2003 {
  ...
  @Rule
  public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_pagetail_L2003");
  ...
  @Test
  public void testTyydWapPagetailL2003() throws Exception {
    driver.get(baseUrl + "/index.action?f=0&fromModule=J-ycindex-endNav-home");
    ...
    assertEquals("女生", driver.findElement(By.xpath("//div[17]/p[1]/a[4]")).getText());
    driver.findElement(By.xpath("//div[17]/p[1]/a[4]")).click();
