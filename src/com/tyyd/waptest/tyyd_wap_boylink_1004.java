...
public class tyyd_wap_boylink_1004 {
...
//		baseUrl = TxtHandle.readData(dataFile, 0);
	...
	@Rule
	public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_boylink_1004");
	...
	@Test
	public void TyydWapBoylink1004() throws Exception {
		driver.navigate().to(baseUrl+"/index.action?f=0");
	    driver.findElement(By.linkText("男生")).click();
	    assertTrue(isElementPresent(By.linkText("军事")));
	    driver.findElement(By.linkText("军事")).click();
	    assertEquals("首页> 男生 > 铁血军事", driver.findElement(By.cssSelector("p")).getText());
