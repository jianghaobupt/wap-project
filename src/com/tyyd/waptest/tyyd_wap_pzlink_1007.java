...
public class tyyd_wap_pzlink_1007 {
...
//		baseUrl = TxtHandle.readData(dataFile, 0);
	...
	@Rule
	public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_pzlink_1007");
	...
	@Test
	public void TyydWapPzlink1007() throws Exception {
		driver.navigate().to(baseUrl+"/index.action?f=0");
	    driver.findElement(By.linkText("品质")).click();
	    assertTrue(isElementPresent(By.linkText("传记")));
	    driver.findElement(By.linkText("传记")).click();
	    assertEquals("首页> 品质 > 纪实传记", driver.findElement(By.cssSelector("p")).getText());
