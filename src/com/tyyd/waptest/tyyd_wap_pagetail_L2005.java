...
public class tyyd_wap_pagetail_L2005 {
  ...
  @Rule
  public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_pagetail_L2005");
  ...
  @Test
  public void testTyydWapPagetailL2005() throws Exception {
    ...
    assertEquals("分类", driver.findElement(By.xpath("//div[17]/p[2]/a[1]")).getText());  
    driver.findElement(By.xpath("//div[17]/p[2]/a[1]")).click();
