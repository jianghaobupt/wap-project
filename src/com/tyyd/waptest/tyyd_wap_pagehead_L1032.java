...
public class tyyd_wap_pagehead_L1032 {
	/**
  ...
  @Rule
  public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_pagehead_L1032");
  ...
  @Test
  public void testTyydWapPageheadL1032_1() throws Exception {
    driver.get(baseUrl + "/index.action?");
    driver.findElement(By.linkText("女生")).click();
    assertTrue(isElementPresent(By.linkText("穿越")));
    driver.findElement(By.linkText("穿越")).click();
    assertEquals("首页> 女生 > 穿越幻想", driver.findElement(By.cssSelector("p")).getText());
    try {
      assertTrue(isElementPresent(By.linkText("最新完本")));
    } catch (Error e) {
  ...
  @Test
  public void testTyydWapPageheadL1032_2() throws Exception {
    driver.get(baseUrl + "/index.action?");
    driver.findElement(By.linkText("女生")).click();
    assertTrue(isElementPresent(By.linkText("穿越")));
    driver.findElement(By.linkText("穿越")).click();
    ...
    try {
      assertTrue(isElementPresent(By.linkText("热门包月")));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
  }
