...
public class tyyd_wap_pzlink_1002 {
...
//		baseUrl = TxtHandle.readData(dataFile, 0);
	...
	@Rule
	public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_pzlink_1002");
	...
	@Test
	public void TyydWapPzlink1002() throws Exception {
