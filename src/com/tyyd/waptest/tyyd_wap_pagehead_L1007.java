...
public class tyyd_wap_pagehead_L1007 {
	/**
  ...
  @Rule
  public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_pagehead_L1007");
  ...
  @Test
  public void testTyydWapPageheadL1007() throws Exception {
    driver.get(baseUrl + "/index.action?f=0");
    driver.findElement(By.linkText("书城")).click();
    assertTrue(isElementPresent(By.linkText("都市")));
    driver.findElement(By.linkText("都市")).click();
    assertEquals("首页> 男生 > 现代都市", driver.findElement(By.cssSelector("p")).getText());
  }
