...
public class tyyd_wap_chpublish_3002 {
...
private static WebDriver driver;
  ...
  @Rule
  public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_chpublish_3002");
  ...
  @Test
  public void testTyydWapChpublish3002_1() throws Exception {
...
//    assertEquals("都市 | 玄幻 | 仙侠 | 新书 | 免费", driver.findElement(By.cssSelector("div.sub-nav > p")).getText());
    try {
      ...
      verificationErrors.append(e.toString()+"link of [限免] isn't present!\n");
    }
  ...
  @Test
  public void testTyydWapChpublish3002_2() throws Exception {
    driver.get(baseUrl + "/index.action?f=2");
    driver.findElement(By.linkText("男生")).click();
    try {
      assertTrue(isElementPresent(By.linkText("限免")));
