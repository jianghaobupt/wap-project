...
public class tyyd_wap_pagetail_L2002 {
  ...
  @Rule
  public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_pagetail_L2002");
  ...
  @Test
  public void testTyydWapPagetailL2002() throws Exception {
    ...
    assertEquals("男生", driver.findElement(By.xpath("//div[17]/p[1]/a[3]")).getText());
