...
public class tyyd_wap_pagehead_L1006 {
	/**
  ...
  @Rule
  public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_pagehead_L1006");
  ...
  @Test
  public void testTyydWapPageheadL1006() throws Exception {
    driver.get(baseUrl + "/index.action?f=0");
    driver.findElement(By.linkText("书城")).click();
    assertTrue(isElementPresent(By.linkText("图书")));
    driver.findElement(By.linkText("图书")).click();
    assertEquals("首页> 图书\n书架", driver.findElement(By.cssSelector("p")).getText());
  }
