...
public class tyyd_wap_pagehead_L1014 {
	/**
  ...
  @Rule
  public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_pagehead_L1014");
  ...
  @Test
  public void testTyydWapPageheadL1014() throws Exception {
