...
public class tyyd_wap_chpublish_2003 {
  ...
  @Rule
  public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_chpublish_2003");
  ...
  @Test
  public void testTyydWapChpublish2003_1() throws Exception {
  ...
  @Test
  public void testTyydWapChpublish2003_2() throws Exception {
    driver.get(baseUrl + "/index.action?f=1");
    driver.findElement(By.linkText("品质")).click();
    assertTrue(isElementPresent(By.linkText("名家")));
    driver.findElement(By.linkText("名家")).click();
