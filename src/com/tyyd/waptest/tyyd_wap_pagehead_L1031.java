...
public class tyyd_wap_pagehead_L1031 {
	/**
  ...
  @Rule
  public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_pagehead_L1031");
  ...
  @Test
  public void testTyydWapPageheadL1031() throws Exception {
    driver.get(baseUrl + "/index.action?");
    driver.findElement(By.linkText("女生")).click();
    assertTrue(isElementPresent(By.linkText("言情")));
    driver.findElement(By.linkText("言情")).click();
    assertEquals("首页> 女生 > 现代言情", driver.findElement(By.cssSelector("p")).getText());
  }
