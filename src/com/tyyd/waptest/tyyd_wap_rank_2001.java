...
public class tyyd_wap_rank_2001 {
	...
	@Rule
	public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_rank_2001");
	...
	@Test
	public void TyydWapRank2001() throws Exception {
		...
		assertEquals("综合", driver.findElement(By.xpath("//div[3]/div/span")).getText());
