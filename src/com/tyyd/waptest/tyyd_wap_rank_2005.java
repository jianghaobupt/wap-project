...
public class tyyd_wap_rank_2005 {
	...
	@Rule
	public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_rank_2005");
	...
	@Test
	public void TyydWapRank2005() throws Exception {
		...
		driver.findElement(By.linkText("飙升榜")).click();
		assertEquals("首页> 榜单> 飙升榜", driver.findElement(By.cssSelector("p")).getText());
