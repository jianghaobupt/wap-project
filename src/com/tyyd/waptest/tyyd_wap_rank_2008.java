...
public class tyyd_wap_rank_2008 {
	...
	@Rule
	public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_rank_2008");
	...
	@Test
	public void TyydWapRank2008() throws Exception {
		driver.navigate().to(baseUrl+"/index.action?f=0");

		driver.findElement(By.linkText("排行")).click();
		try {
			assertTrue(isElementPresent(By.linkText("个性榜")));
		} catch (Error e){
			verificationErrors.append(e.toString()+"link isn't present!\n");
		}
		driver.findElement(By.linkText("个性榜")).click();
		driver.findElement(By.linkText("口碑")).click();
		assertEquals("口碑", driver.findElement(By.xpath("//div[3]/div/span")).getText());
		assertEquals("首页> 榜单> 个性榜", driver.findElement(By.cssSelector("p")).getText());
