...
public class tyyd_wap_pzlink_1004 {
...
//		baseUrl = TxtHandle.readData(dataFile, 0);
	...
	@Rule
	public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_pzlink_1004");
	...
	@Test
	public void TyydWapPzlink1004() throws Exception {
	    ...
	    assertEquals("首页> 品质 > 科幻小说", driver.findElement(By.cssSelector("p")).getText());
