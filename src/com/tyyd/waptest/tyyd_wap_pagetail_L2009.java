...
public class tyyd_wap_pagetail_L2009 {
  ...
  @Rule
  public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_pagetail_L2009");
  ...
  @Test
  public void testTyydWapPagetailL2009() throws Exception {
    driver.get(baseUrl + "/index.action?");
    driver.findElement(By.linkText("书城")).click();
    assertEquals("免费", driver.findElement(By.xpath("//div[17]/p[1]/a[2]")).getText());  
    driver.findElement(By.xpath("//div[17]/p[1]/a[2]")).click();
