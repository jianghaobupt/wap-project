...
public class tyyd_wap_rank_2002 {
	...
	@Rule
	public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_rank_2002");
	...
	@Test
	public void TyydWapRank2002() throws Exception {
		driver.navigate().to(baseUrl+"/index.action?f=1");
		...
		assertEquals("品质", driver.findElement(By.xpath("//div[3]/div/span")).getText());
