...
public class tyyd_wap_pzlink_1003 {
...
//		baseUrl = TxtHandle.readData(dataFile, 0);
	...
	@Rule
	public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_pzlink_1003");
	...
	@Test
	public void TyydWapPzlink1003() throws Exception {
	    ...
	    assertEquals("首页> 品质 > 历史故事", driver.findElement(By.cssSelector("p")).getText());
