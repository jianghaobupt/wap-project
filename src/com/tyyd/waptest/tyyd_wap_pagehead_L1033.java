...
public class tyyd_wap_pagehead_L1033 {
	/**
  ...
  @Rule
  public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_pagehead_L1033");
  ...
  @Test
  public void testTyydWapPageheadL1033_1() throws Exception {
    driver.get(baseUrl + "/index.action?");
    driver.findElement(By.linkText("女生")).click();
    assertTrue(isElementPresent(By.linkText("青春")));
    driver.findElement(By.linkText("青春")).click();
    assertEquals("首页> 女生 > 甜美青春", driver.findElement(By.cssSelector("p")).getText());
    try {
      assertTrue(isElementPresent(By.linkText("最新连载")));
    } catch (Error e) {
  ...
  @Test
  public void testTyydWapPageheadL1033_2() throws Exception {
    driver.get(baseUrl + "/index.action?");
    driver.findElement(By.linkText("女生")).click();
    assertTrue(isElementPresent(By.linkText("青春")));
    driver.findElement(By.linkText("青春")).click();
    ...
    try {
      assertTrue(isElementPresent(By.linkText("热门专题")));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
  }
