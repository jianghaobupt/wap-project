...
public class tyyd_wap_rank_2007 {
	...
	@Rule
	public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_rank_2007");
	...
	@Test
	public void TyydWapRank2007() throws Exception {
		...
		assertEquals("收藏", driver.findElement(By.xpath("//div[3]/div/span")).getText());
