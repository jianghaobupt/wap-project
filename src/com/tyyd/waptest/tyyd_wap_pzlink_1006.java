...
public class tyyd_wap_pzlink_1006 {
...
//		baseUrl = TxtHandle.readData(dataFile, 0);
	...
	@Rule
	public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_pzlink_1006");
	...
	@Test
	public void TyydWapPzlink1006() throws Exception {
