...
public class tyyd_wap_pzlink_1008 {
...
//		baseUrl = TxtHandle.readData(dataFile, 0);
	...
	@Rule
	public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_pzlink_1008");
	...
	@Test
	public void TyydWapPzlink1008() throws Exception {
		driver.navigate().to(baseUrl+"/index.action?f=0");
	    driver.findElement(By.linkText("品质")).click();
	    assertTrue(isElementPresent(By.linkText("生活")));
	    driver.findElement(By.linkText("生活")).click();
	    assertEquals("首页> 品质 > 生活时尚", driver.findElement(By.cssSelector("p")).getText());
