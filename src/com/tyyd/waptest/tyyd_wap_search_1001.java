...
public class tyyd_wap_search_1001 {
	...
	public static void start() throws Exception {
		...
		searchName = ExcelHandle.readExcel(dataFile, 0, 5, 1);
		driver =  new FirefoxDriver();
//		driver =  new HtmlUnitDriver();
	}
		  
	@Rule
	public TestRule myScreenshot = new TakeScreenshotOnFailureRule(driver, "tyyd_wap_search_1001");
	...
	@Test
	public void TyydWapSearch1001() throws Exception {
